...
def location_dumper(location: str | WKBElement) -> str:
    ...
    # но мы можем туда присваивать строку потому что внутри оно маппиться на WKBElement
    # лучше было бы сделать через преобразование на уровне самой алхимии, но я пока не знаю как
